...
void disp()
{
	...
	P1=~(32>>disp_com);//1<<disp_com为1个“1”7个“0”，因数码管为共阴，若不反向则会7只数码亮一只不亮，按位反向后输出就能保证只有指定位亮了。;
...
void main()
{
	...
	int1_init();
	EA=1;//总的中断允许
	disp_buf_change(dat>=100000?dat/100000:10,dat>=10000?dat%100000/10000:10,dat>=1000?dat%10000/1000:10,dat>=100?dat%1000/100:10,dat>=10?dat%100/10:10,dat%10);//初始显示0
	while(1);
}
